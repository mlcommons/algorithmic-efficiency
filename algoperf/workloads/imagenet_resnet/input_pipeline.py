...
from algoperf.workloads.imagenet_resnet import randaugment
...
def create_split(
  ...
  Args:
    image_format: Output image format. 'NHWC' (default, TensorFlow/JAX style)
      or 'NCHW' (PyTorch style). When 'NCHW', images are transposed after
      batching.
  """
  ...
  # Transpose to NCHW format if requested (for PyTorch)
