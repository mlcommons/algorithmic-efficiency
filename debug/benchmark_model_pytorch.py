...
def main():
  ...
  if RANK == 0:
    print(f'=== PyTorch ResNet50 Model Benchmark ===')
  ...
  inputs = torch.randn(per_device_batch_size, 3, IMAGE_SIZE, IMAGE_SIZE, device=DEVICE)
  targets = torch.randint(0, NUM_CLASSES, (per_device_batch_size,), device=DEVICE)
