...
workload_metadata = {
    ...
    'criteo1tb_jax': {
        'validation_target':
            Criteo1TbDlrmSmallWorkload().validation_target_value,
        'test_target':
            Criteo1TbDlrmSmallWorkload().test_target_value,
        'validation_metric':
            'validation/loss',
        'test_metric':
            'test/loss',
    ...
    'librispeech_conformer_jax': {
        'validation_target':
            LibriSpeechConformerWorkload().validation_target_value,
        'test_target':
            LibriSpeechConformerWorkload().test_target_value,
        'validation_metric':
            'validation/wer',
        'test_metric':
            'test/wer',
    ...
    'librispeech_deepspeech_jax': {
        'validation_target':
            LibriSpeechDeepSpeechWorkload().validation_target_value,
        'test_target':
            LibriSpeechDeepSpeechWorkload().test_target_value,
        'validation_metric':
            'validation/wer',
        'test_metric':
            'test/wer'
