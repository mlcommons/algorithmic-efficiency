"""
This is a pytorch implementation mirroring: https://github.com/google/init2winit/blob/master/init2winit/model_lib/spectrum_augmenter.py
"""
...
class SpecAug(nn.Module):
    ...
    def _get_mask(self,
        ...
        masked_portion = torch.rand(
            batch_size, multiplicity, device=device)
