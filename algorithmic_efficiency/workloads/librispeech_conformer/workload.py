...
class BaseLibrispeechWorkload(spec.Workload):
    ...
    def build_input_queue(
        ...
        return self._build_dataset(
            data_rng, split, data_dir, global_batch_size, num_batches
        )
    ...
    def _build_dataset(
        ...
        ds = input_pipeline.get_librispeech_dataset(
            split, data_dir, data_rng, train, batch_size, num_batches
        )
    ...
    def output_activation_fn(
        self, logits: spec.Tensor, loss_type: spec.LossType
    ) -> spec.Tensor:
        pass
